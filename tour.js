...
(function () {
  ...
  const PAGE_TIPS = {
    ...
    tasks: {
      ...
      body: 'Type something specific — "Solve Ex 2.3" beats "study math" — then tap Add. These are separate from your syllabus chapters.',
    },
    backlog: {
      target: '[onclick*="Backlog.openAddModal"]',
      fallback: '#content',
      position: 'top',
      title: 'Tap + Add Item to log study debt',
      body: 'Falling behind on a chapter? Add it here so it doesn\'t get forgotten — you can push it back to Tasks or mark it done later.',
    },
    revisions: {
