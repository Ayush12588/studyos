...
(function () {
  ...
  const _CBSE = {
    ...
    '10': {
      ...
      'English': { 'A Letter to God':4,'Nelson Mandela':4,'Two Stories about Flying':4,'Anne Frank Diary':4,'Glimpses of India':4,'Mijbil the Otter':4,'Madam Rides the Bus':4,'The Sermon at Benares':4,'The Proposal':5,'Dust of Snow (Poem)':2,'Fire and Ice (Poem)':2,'A Tiger in the Zoo (Poem)':2,'How to Tell Wild Animals (Poem)':2,'The Ball Poem (Poem)':2,'Amanda! (Poem)':2,'The Trees (Poem)':2,'Fog (Poem)':2,'The Tale of Custard the Dragon (Poem)':2,'For Anne Gregory (Poem)':2 },
    },
    '11_PCM': {
