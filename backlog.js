...
(function () {
  ...
  const _CBSE = {
    '9': {
      'Mathematics': { 'Orienting Yourself: The Use of Coordinates':4,'Introduction to Linear Polynomials':10,'The World of Numbers':7,'Exploring Algebraic Identities':5,'Measuring Space: Perimeter and Area':14,'The Mathematics of Maybe: Introduction to Probability':10,'Predicting What Comes Next: Exploring Sequences and Progressions':5 },
      'Science': { 'Cell':6,'Tissues':7,'Reproduction':7,'Diversity':7,'Exploring Mixtures and their Separation':7,'Structure of an Atom':9,'Atoms and Molecules':9,'Motion':6,'Force and Laws of Motion':6,'Work, Energy and Simple Machines':6,'Sound':5,'Earth as a System: Energy, Matter and Life':5 },
      'Social Science': { 'Understanding Social Science':3,"Shaping of the Earth's Surface":5,'Atmosphere and Climate':4,'Early Humans and Beginning of Civilisation':6,'State and Society up to 1000 CE':6,'Democracy':6,'Elections':6,'Building Blocks in Economics':4,'The Price Puzzle: What Drives the Market':5,'Oceans and Life':4,'Life on Earth':4,'Resistance and Resilience (1000 CE–1700 CE)':6,'India and the World-I (1900 BCE–1200 CE)':5,'Authority':7,'From Ideas to Startups':5,'Smart Ways to Manage Your Finances':4 },
      'English': { 'How I Taught My Grandmother to Read':3,'The Pot Maker':2,'Winds of Change':2,'Vitamin-M':2,'The World of Limitless Possibilities':2,'Twin Melodies':2,'Carrier of Words':2,'Follow That Dream':2,'Gifts of Grace: Honouring our Vocations':2,'Canvas of Soil':2,'I Cannot Remember My Mother':2,'Nine Gold Medals':2,'A Friend Found in Music':2,'Words':2,'Believe in Yourself':1 },
    },
    '10': {
