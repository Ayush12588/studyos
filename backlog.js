...
(function () {
  ...
  const _CBSE = {
    ...
    '10': {
      ...
      'English': { 'A Letter to God':2, 'Nelson Mandela: Long Walk to Freedom':2, 'Two Stories about Flying':2, 'From the Diary of Anne Frank':2, 'Glimpses of India':2, 'Mijbil the Otter':2, 'Madam Rides the Bus':2, 'The Sermon at Benares':2, 'The Proposal (Play)':2, 'Dust of Snow (Poem)':1, 'Fire and Ice (Poem)':1, 'A Tiger in the Zoo (Poem)':1, 'How to Tell Wild Animals (Poem)':1, 'The Ball Poem (Poem)':1, 'Amanda! (Poem)':1, 'The Trees (Poem)':1, 'Fog (Poem)':1, 'The Tale of Custard the Dragon (Poem)':1, 'For Anne Gregory (Poem)':1, 'A Triumph of Surgery':2, 'The Thief\'s Story':2, 'The Midnight Visitor':2, 'A Question of Trust':2, 'Footprints Without Feet':2, 'The Making of a Scientist':2, 'The Necklace':2, 'Bholi':2, 'The Book that Saved the Earth':2 },
    },
    '11_PCM': {
